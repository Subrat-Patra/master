    ...
    <div>
              ...
              <div className="w-auto hidden xl:block">
                <ul className="flex items-center mr-10">
                  ...
                  <li className="group hover-trigger font-heading mr-9 text-lg z-5">
                    ...
                    <div className="hover-target submenu absolute group-hover:transition duration-300 shadow-xl"></div>
                  </li>
          ...
          <div className=" w-[70%]">
            ...
            <div className="w-auto ml-4">
              <img
                ...
                width="150"
                height="150"
                className="w-40 transform-white "
              />

              <div className='class="mb-6 font-heading flex xl:block justify-center '></div>
              <h1 className="text-center xl:text-left font-heading text-white text-5xl md:text-7xl xl:text-10xl 2xl:text-12xl font-medium mb-6 ">
                La dématérialisation<br></br>au service de votre business
              </h1>
      ...
      <div className="bg-teal-50 h-auto ">
        <div className="   h-auto ml-56 mr-56  pt-4 pb-24 ">
          <div>
            <p className="font-medium pt-2">TRELLO 101</p>
